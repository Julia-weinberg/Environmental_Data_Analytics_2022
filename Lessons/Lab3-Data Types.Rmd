...
```{r}
vector3 <- c(30,30,18,26,26,18,26,26,28,40,44,40,35,30,31)
vector3
vector4 <- c(49,57,40,41,44,37,41,51,52,52,60,59,52,47,49)
vector4
```
...
```{r}
vector5 <- c(.5556*(vector3-32))
vector5
vector6 <- c(.5556*(vector4-32))
vector6
```
...
```{r}
temperature.dataframe <-data.frame(vector3,vector4,vector5,vector6)
names(temperature.dataframe)<-c("High F","Low F","High C","Low C");View(temperature.dataframe)
...
```{r}
summary(temperature.dataframe)
summary(temperature.dataframe$`High F`)
summary(temperature.dataframe$`Low F`)
summary(temperature.dataframe$`High C`)
summary(temperature.dataframe$`Low C`)
sd(temperature.dataframe$`High F`)
sd(temperature.dataframe$`High C`)
sd(temperature.dataframe$`Low F`)
sd(temperature.dataframe$`Low C`)
