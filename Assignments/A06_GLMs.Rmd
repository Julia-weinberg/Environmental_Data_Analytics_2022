...
TEMP.by.all.regression <- lm(data = July.Temps.subset, temperature_C ~ depth + 
              year4 + daynum) 
#create regression of temperature with chosen variables

step(TEMP.by.all.regression) #get step values


#10


TEMP.by.all.regression <- lm(data = LTER.AIC, temperature_C ~ depth + year4 + 
daynum)
summary(TEMP.by.all.regression) #get summary of temperature by chosen variables
...
>Answer: Central Long Lake, Crampton Lake, East Long Lake, Tuesday Lake, and West Long Lake all have statistically similar mean. 
