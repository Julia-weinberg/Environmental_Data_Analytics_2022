...
#change PeterPaul.chem.nutrients to date format

PeterPaul.chem.physics$sampledate <- as.Date(PeterPaul.chem.physics$sampledate) 
#change PeterPaul.chem.physics to date format
...
```{r}
#4
P.by.Po <-ggplot(PeterPaul.chem.nutrients, aes(x = po4, y = tp_ug, color = "black`3")) +
  geom_point() +
